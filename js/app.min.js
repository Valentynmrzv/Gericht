...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n/* harmony import */ var _modules_mobile_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/mobile-menu.js */ \"./src/js/modules/mobile-menu.js\");\n/* harmony import */ var _modules_video_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/video.js */ \"./src/js/modules/video.js\");\n/* harmony import */ var _modules_videoPlayerAbout_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/videoPlayerAbout.js */ \"./src/js/modules/videoPlayerAbout.js\");\n/* harmony import */ var _modules_back_to_top_btn_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/back-to-top-btn.js */ \"./src/js/modules/back-to-top-btn.js\");\n/* harmony import */ var _modules_slick_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slick.js */ \"./src/js/modules/slick.js\");\n/* harmony import */ var _modules_slaider_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/slaider.js */ \"./src/js/modules/slaider.js\");\n/* harmony import */ var _modules_datepicker_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/datepicker.js */ \"./src/js/modules/datepicker.js\");\n/* harmony import */ var _modules_swiper_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/swiper.js */ \"./src/js/modules/swiper.js\");\n/* harmony import */ var _modules_coming_soon_section_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/coming-soon-section.js */ \"./src/js/modules/coming-soon-section.js\");\n\r\n\r\n// flsFunctions.isWebp();\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://gulp/./src/js/app.js?");

/***/ }),

/***/ "./src/js/modules/back-to-top-btn.js":
/*!*******************************************!*\
  !*** ./src/js/modules/back-to-top-btn.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var vanilla_back_to_top__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vanilla-back-to-top */ \"./node_modules/vanilla-back-to-top/dist/vanilla-back-to-top.umd.js\");\n\r\n\r\n(0,vanilla_back_to_top__WEBPACK_IMPORTED_MODULE_0__.addBackToTop)({\r\n  diameter: 25,\r\n  backgroundColor: \"#dcca87\",\r\n  textColor: \" #0c0b08\",\r\n\r\n  scrollDuration: 500,\r\n});\r\n\n\n//# sourceURL=webpack://gulp/./src/js/modules/back-to-top-btn.js?");

/***/ }),

/***/ "./src/js/modules/coming-soon-section.js":
/*!***********************************************!*\
  !*** ./src/js/modules/coming-soon-section.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n// class CountdownTimer {\r\n//   constructor({ selector, targetTime }) {\r\n//     this.targetTime = targetTime;\r\n//     this.selector = document.querySelector(`${selector}`);\r\n//     this.days = this.selector.querySelector('span[data-value=\"days\"]');\r\n//     this.hours = this.selector.querySelector('span[data-value=\"hours\"]');\r\n//     this.mins = this.selector.querySelector('span[data-value=\"mins\"]');\r\n//     this.secs = this.selector.querySelector('span[data-value=\"secs\"]');\r\n//     this.runTimer();\r\n//   }\r\n\r\n//   runTimer() {\r\n//     interval: null;\r\n\r\n//     setTimeout(() => {\r\n//       this.timer();\r\n\r\n//       this.interval = setInterval(() => {\r\n//         this.timer();\r\n//       }, 1000);\r\n//     });\r\n//   }\r\n\r\n//   timer() {\r\n//     const currentTime = new Date();\r\n//     const differenceTime = this.targetTime - currentTime;\r\n//     this.dataTime(differenceTime);\r\n//   }\r\n\r\n//   dataTime(time) {\r\n//     const days = Math.floor(time / (1000 * 60 * 60 * 24));\r\n//     this.days.textContent = days;\r\n\r\n//     const hours = Math.floor((time % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));\r\n//     this.hours.textContent = hours;\r\n\r\n//     const mins = Math.floor((time % (1000 * 60 * 60)) / (1000 * 60));\r\n//     this.mins.textContent = mins;\r\n\r\n//     const secs = Math.floor((time % (1000 * 60)) / 1000);\r\n//     this.secs.textContent = secs;\r\n\r\n//     if (days == 0 && hours == 0 && mins == 0 && secs == 0) {\r\n//       this.stopInterval();\r\n//     }\r\n//   }\r\n\r\n//   stopInterval() {\r\n//     clearInterval(this.interval);\r\n//   }\r\n// }\r\n\r\n// const counterDown = new CountdownTimer({\r\n//   selector: \"#timer-1\",\r\n//   targetTime: new Date(\"Octovber 24, 2024 10:35:00\").getTime(),\r\n// });\r\n\r\n\r\nclass CountdownTimer {\r\n  constructor({ selector, targetTime }) {\r\n    this.targetTime = targetTime;\r\n    this.selector = document.querySelector(`${selector}`);\r\n    this.days = this.selector ? this.selector.querySelector('span[data-value=\"days\"]') : null;\r\n    this.hours = this.selector ? this.selector.querySelector('span[data-value=\"hours\"]') : null;\r\n    this.mins = this.selector ? this.selector.querySelector('span[data-value=\"mins\"]') : null;\r\n    this.secs = this.selector ? this.selector.querySelector('span[data-value=\"secs\"]') : null;\r\n\r\n    if (this.selector && this.days && this.hours && this.mins && this.secs) {\r\n      this.runTimer();\r\n    }\r\n  }\r\n\r\n  runTimer() {\r\n    setTimeout(() => {\r\n      this.timer();\r\n\r\n      this.interval = setInterval(() => {\r\n        this.timer();\r\n      }, 1000);\r\n    });\r\n  }\r\n\r\n  timer() {\r\n    const currentTime = new Date();\r\n    const differenceTime = this.targetTime - currentTime;\r\n    this.dataTime(differenceTime);\r\n  }\r\n\r\n  dataTime(time) {\r\n    const days = Math.floor(time / (1000 * 60 * 60 * 24));\r\n    this.days.textContent = days;\r\n\r\n    const hours = Math.floor((time % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));\r\n    this.hours.textContent = hours;\r\n\r\n    const mins = Math.floor((time % (1000 * 60 * 60)) / (1000 * 60));\r\n    this.mins.textContent = mins;\r\n\r\n    const secs = Math.floor((time % (1000 * 60)) / 1000);\r\n    this.secs.textContent = secs;\r\n\r\n    if (days == 0 && hours == 0 && mins == 0 && secs == 0) {\r\n      this.stopInterval();\r\n    }\r\n  }\r\n\r\n  stopInterval() {\r\n    clearInterval(this.interval);\r\n  }\r\n}\r\n\r\nconst counterDown = new CountdownTimer({\r\n  selector: \"#timer-1\",\r\n  targetTime: new Date(\"Octovber 24, 2024 10:35:00\").getTime(),\r\n});\r\n\n\n//# sourceURL=webpack://gulp/./src/js/modules/coming-soon-section.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n(() => {\r\n  const menuBtnRef = document.querySelector('[data-menu-button]');\r\n  const mobileMenuRef = document.querySelector('[data-menu]');\r\n  const mobileBtnClose = document.querySelector('[data-menu-close]');\r\n\r\n  menuBtnRef.addEventListener('click', () => {\r\n    mobileMenuRef.classList.toggle('is-open');\r\n  });\r\n\r\n  mobileBtnClose.addEventListener('click', () => {\r\n    mobileMenuRef.classList.toggle('is-open');\r\n  });\r\n})();\n\n//# sourceURL=webpack://gulp/./src/js/modules/mobile-menu.js?");

/***/ }),

/***/ "./src/js/modules/slaider.js":
/*!***********************************!*\
  !*** ./src/js/modules/slaider.js ***!
  \***********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n$(document).ready(function () {\r\n  $(\".slider\").slick({\r\n    arrows: false,\r\n    dots: true,\r\n    adaptiveHeight: false,\r\n    slidesToShow: 1,\r\n    slidesToScroll: 1,\r\n    speed: 1000,\r\n    easing: \"ease\",\r\n    infinite: false,\r\n    autoplay: true,\r\n    autoplaySpeed: 3000,\r\n    pauseOnFocus: true,\r\n    pauseOnHover: true,\r\n    draggable: true,\r\n    swipe: true,\r\n    touchThreshold: 2,\r\n    touchMove: false,\r\n    waitForAnimate: true,\r\n  });\r\n});\r\n\n\n//# sourceURL=webpack://gulp/./src/js/modules/slaider.js?");
